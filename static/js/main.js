document.addEventListener('DOMContentLoaded', () => {
    ...
    if (achievementsDataElement && achievementsDataElement.textContent) {
        ...
        console.warn("Element with ID 'achievements-data' not found or empty. Achievements popups might not work.");
    }
...
document.body.addEventListener("achievementsUnlocked", function (evt) {
    ...
    if (!all_achievements_data || !all_achievements_data.confetti_types || !all_achievements_data.sounds) {
        console.error("all_achievements_data is not properly initialized in main.js.");
        return;
    }
